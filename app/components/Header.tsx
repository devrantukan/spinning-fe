  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-gray-900 shadow-md">
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="py-4 px-4 sm:px-6 space-y-4 border-t border-gray-200 dark:border-gray-700">
            {!user &&
              menuItems.map((item) => (
                <Link
                  key={item.href}
            ...
            {user ? (
              ...
              <button
                ...
                className="w-full bg-orange-500 text-white px-4 py-3 rounded-full font-semibold hover:bg-orange-600 transition-colors duration-200 text-center mt-4 cursor-pointer text-base overflow-hidden"
              >
                {t("nav.joinUs")}
              </button>
            )}
